                    ...
                    <div class="col-md-6 col-lg-5 p-b-30">
                        <div class="p-r-50 p-t-5 p-lr-0-lg">
                            <h4 class="mtext-105 cl2 js-name-detail p-b-14" >
                                ...
                                <c:if test="${pd.product_price!=pd.product_price*(100-pd.product_saleprice)/100}">
                            ...
                            <div style="color: red; transform: translateY(10px)">${messwish}</div>
...
<!--                                <input type="hidden" name="user_id" value="${sessionScope.acc.user_id}">-->
                                <div class="p-t-33">
                                    <div class="flex-w flex-r-m p-b-10">
                                        ...
                                        <div class="size-204 respon6-next">
                                            <div class="rs1-select2 bor8 bg0">
                                                <select class="js-select2" name="size" onchange="checkquantity()" id="sizeid" >
                                                    <c:forEach items="${requestScope.ls}" var="o">
                                                        <option value="${o.sizeId}" >
                                                            <c:forEach items="${size}" var="i">
                                                                <c:if test="${o.sizeId==i.size_id}">${i.size}</c:if>
                                                            </c:forEach>
                                                        </option>
                                                    </c:forEach>
                                                </select>
                                    ...
                                    <div class="flex-w flex-r-m p-b-10">
                                        ...
                                        <div class="size-204 respon6-next " id="quantity" >
                                            <div class="rs1-select2 bor8 bg0">
                                                <c:forEach items="${requestScope.ls}" var="o" begin="0" end="0" >
                                                    &nbsp;&nbsp;&nbsp; ${o.quantity}
                            ...
                            <div class="flex-w flex-m p-l-100 p-t-40 respon7">
                                <div class="flex-m bor9 p-r-10 m-r-11">
                                    <a href="wishlist?pid=${pd.product_id}&action=add" class="fs-14 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2 js-addwish-detail tooltip100" data-tooltip="Add to Wishlist">
                                            ...
                                            <c:forEach items="${requestScope.list}" var="s">
                                                <div class="flex-w flex-t p-b-68">
                                                    ...
                                                    <div class="size-207">
                                                        ...
                                                        <div style="width: 109px;height: 109px;"  class="">
                                                            <img src="img_product/${s.getFeedback_img()}" style="width: 109px;height: 109px;" alt="IMG">
                                                        </div>
        ...
        <style>.square {
                width: 109px; /* Adjust width to your desired size */
                height: 109px; /* Set height to match width for a square aspect ratio */
            }</style>
