		...
		<div class="sidebar flex-col-l p-t-22 p-b-25">
			...
			<div class="sidebar-content flex-w w-full p-lr-65 js-pscroll">
				...
				<c:if test="${sessionScope.acc.user_roleId=='4'}">	
					...
					<li class="p-b-13">
						<a href="updateprofile" class="stext-102 cl2 hov-cl1 trans-04">
							My Profile
						</a>
					</li>
					...
					<li class="p-b-13">
						<a href="changePassword.jsp" class="stext-102 cl2 hov-cl1 trans-04">
							Change Password
						</a>
					</li>
                                        </c:if>
				...
				<div class="sidebar-gallery w-full">
					<span class="mtext-101 cl5">
						About Us
                                    ...
                                    <p class="stext-108 cl6 p-t-27" style="color: black">
