 ...
 * @author Cao Duy Quân
 */
public class ManageOrderStatus extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Users ui = (Users) session.getAttribute("acc");
        String emailu = ui.getUser_email();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(status.equals("3")){
            OrderDAO.UpdateOrderStatusFeedback("1",oid);
        }
