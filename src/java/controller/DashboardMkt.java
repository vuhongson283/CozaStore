 ...
 * @author TTT
 */
public class DashboardMkt extends HttpServlet {

    List<String> listYear = new ArrayList<>();
    DashboardDAO db = new DashboardDAO();
    List<Integer> listYearUse = new ArrayList<>();
    String bestSeller = db.getBestSeller();
    int totalCus = db.getTotalCus();
    int newPro = db.getNewPro();
    int newBlog = db.getNewBlog();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        bestSeller = db.getBestSeller();
        totalCus = db.getTotalCus();
        newPro = db.getNewPro();
        newBlog = db.getNewBlog();
        ...
        request.getRequestDispatcher("DashboardMkt.jsp").forward(request, response);
    }
