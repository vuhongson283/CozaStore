                        ...
                        <div class="card-body" style="min-height: 0px;">
                            <form action="resetpassword" method="POST">
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input name="gmail" type="text" class="form-control" required placeholder="Gmail">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <c:if test="${requestScope.invalidGmail!=null}">
                                                <p style="color: red">${requestScope.invalidGmail}</p>
                                            </c:if>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div >
                                    ...
                                    <input type="submit" class="flex-c-m stext-101 cl0 size-121 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer btn"  value="Submit">
                                </div>
                            </form>      
                        </div>
                    </div>
