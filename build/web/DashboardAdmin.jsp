            ...
            <jsp:include page="component/admin/slidebar.jsp"></jsp:include>
                ...
                <div class="content">
                    ...
                    <jsp:include page="component/admin/navbar.jsp"></jsp:include>
                        <div class="row">
                            <div class="col-lg-3 box_info" style="display: flex; border: 0.1px solid #ebe7e7;box-shadow: rgba(136, 165, 191, 0.48) 6px 2px 16px 0px, rgba(255, 255, 255, 0.8) -6px -2px 16px 0px; margin-top: 30px; margin-left: 11px;width: 23%;">
                                <div class="col-lg-6" style="margin-top: 12px;">
                                    <i class="fa-solid fa-heart" style="font-size: 54px;
                                       margin-left: 12%;
                                       margin-top: 10%;"></i>
                                </div>
                                <div class="col-lg-6" style="margin-top: 12px;">
                                    <h6 style="margin-bottom: 0px">Best-selling Brand</h6>
                                    <h3 style="margin-top: 13%;
                                    margin-left: 40%;font-style: italic; color: green">Puma</h3>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 box_info" style="display: flex; border: 0.1px solid #ebe7e7;box-shadow: rgba(136, 165, 191, 0.48) 6px 2px 16px 0px, rgba(255, 255, 255, 0.8) -6px -2px 16px 0px; margin-top: 30px; margin-left: 11px; width: 23%;">
                            <div class="col-lg-6" style="margin-top: 12px;">
                                    <i class="fa-solid fa-users" style="font-size: 54px;
                                       margin-left: 12%;
                                       margin-top: 10%;"></i>
                                </div>
                                <div class="col-lg-6" style="margin-top: 12px;">
                                    <h6 style="margin-bottom: 0px">Total Users</h6>
                                    <h1 style="margin-top: 14%; margin-left: 16%; color: green">${totalUser}</h1>
                            </div>
                        </div>
                        <div class="col-lg-3 box_info" style="display: flex; border: 0.1px solid #ebe7e7;box-shadow: rgba(136, 165, 191, 0.48) 6px 2px 16px 0px, rgba(255, 255, 255, 0.8) -6px -2px 16px 0px; margin-top: 30px; margin-left: 11px;width: 22%;">
                            <div class="col-lg-6" style="margin-top: 12px;">
                    ...
                    <form action="DashboardAdmin" method="post" id="frm">
