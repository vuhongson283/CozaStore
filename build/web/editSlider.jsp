                ...
                <div class="content">
                    ...
                    <jsp:include page="component/admin/navbar.jsp"></jsp:include>
                        ...
                        <div class="container pt-4 px-4">
                            <div class="row">
                                <form name="productForm" onsubmit="return validateForm()" action="editSlider" method="POST" enctype="multipart/form-data">
                                    <h2 class="mb-3">Edit Slide</h2>

                                    <br>
                                    <label for="name">Slider Id:</label><br>
                                    <input type="text" id="productName" name="id" value="${slide.slide_id}" required="" readonly=""><br>
                                <label for="name">Slider Title:</label><br>
                                <input type="text" id="productName" name="title" value="${slide.slide_title}" required=""><br>
                                <label for="photo">Upload Images:</label><br>
                                <img width="100px" src="images/${slide.slide_image}">
                                <input type="file" accept="image/*" class="form-control"  name="photo" id="recipient-name"><br>
                                <label for="name">Backlink:</label><br>
                                <input type="text" id="productName" value="${slide.backlink}" name="backlink" required=""><br>

                                <label for="supplier">Status:</label><br>
                                <select id="brand" name="status">

                                    <option  value="1" ${slide.slide_status == 1 ? 'selected' : ''}>Available</option>
                                    <option  value="0" ${slide.slide_status == 0 ? 'selected' : ''}>Not Available</option>
