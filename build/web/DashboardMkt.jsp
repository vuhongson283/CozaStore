    ...
    <jsp:include page="component/admin/header.jsp"></jsp:include>
            ...
            <jsp:include page="component/admin/slidebarmarketing.jsp"></jsp:include>
                ...
                <div class="content">
                    ...
                    <jsp:include page="component/admin/navbar.jsp"></jsp:include>
                        <div class="row">
                            <div class="col-lg-3 box_info" style="display: flex; border: 0.1px solid #ebe7e7;box-shadow: rgba(136, 165, 191, 0.48) 6px 2px 16px 0px, rgba(255, 255, 255, 0.8) -6px -2px 16px 0px; margin-top: 30px; margin-left: 11px;width: 23%;">
                                <div class="col-lg-6" style="margin-top: 12px;">
                                    <i class="fa-solid fa-star" style="font-size: 54px;
                                       margin-left: 12%;
                                       margin-top: 10%;"></i>
                                </div>
                                <div class="col-lg-6" style="margin-top: 12px;">
                                    <h6>Best Seller</h6>
                                    <h4 style="font-style: italic; color: green">${bestSeller}</h4>
                            </div>
                        </div>
                        <div class="col-lg-3 box_info" style="display: flex; border: 0.1px solid #ebe7e7;box-shadow: rgba(136, 165, 191, 0.48) 6px 2px 16px 0px, rgba(255, 255, 255, 0.8) -6px -2px 16px 0px; margin-top: 30px; margin-left: 11px; width: 23%;">
                            <div class="col-lg-6" style="margin-top: 12px;">
                                <i class="fa-solid fa-user" style="font-size: 54px;
                                   margin-left: 12%;
                                   margin-top: 10%;"></i>
                            </div>
                            <div class="col-lg-6" style="margin-top: 12px;">
                                <h6 style="margin-bottom: 0px">Customer Active</h6>
                                <h1 style="margin-top: 10%;
                                    margin-left: 73%;">${totalCus}</h1>
                            </div>
                        </div>
                        <div class="col-lg-3 box_info" style="display: flex; border: 0.1px solid #ebe7e7;box-shadow: rgba(136, 165, 191, 0.48) 6px 2px 16px 0px, rgba(255, 255, 255, 0.8) -6px -2px 16px 0px; margin-top: 30px; margin-left: 11px; width: 23%;">
                            <div class="col-lg-6" style="margin-top: 12px;">
                                <i class="fa-solid fa-cubes" style="font-size: 54px;
                                   margin-left: 12%;
                                   margin-top: 10%;"></i>
                            </div>
                            <div class="col-lg-6" style="margin-top: 12px;">
                                <h6 style="margin-left: 28%;">New product</h6>
                                <h1 style="margin-top: 10%;
                                    margin-left: 60%;">${newPro}</h1>
                            </div>
                        </div>
                        <div class="col-lg-3 box_info" style="display: flex; border: 0.1px solid #ebe7e7;box-shadow: rgba(136, 165, 191, 0.48) 6px 2px 16px 0px, rgba(255, 255, 255, 0.8) -6px -2px 16px 0px; margin-top: 30px; margin-left: 11px;width: 23%;">
                            <div class="col-lg-6" style="margin-top: 12px;">
                                <i class="fa-solid fa-blog" style="font-size: 54px;
                                   margin-left: 12%;
                                   margin-top: 10%;"></i>
                            </div>
                            <div class="col-lg-6" style="margin-top: 12px;">
                                <h6 style="margin-left: 28%;">New blog</h6>
                                <h1 style="margin-top: 10%;
                                    margin-left: 60%;">${newBlog}</h1>
                            </div>
                        </div>
                    </div>
                    <form action="DashboardMkt" method="post" id="frm">
        ...
        <script>
            function updateFil() {
                ...
                $.ajax({
                    type: "get",
                    url: "/SWP-demo3/FilterTypeDateMkt",
                    data: {
